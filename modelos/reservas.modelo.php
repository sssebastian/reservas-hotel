...
Class ModeloReservas{
	...
	static public function mdlMostrarReservas($tabla1,$tabla2,$tabla3,$valor){
		...
		$stmt = Conexion::conectar()->prepare("SELECT $tabla1.*, $tabla2.*, $tabla3.* FROM $tabla1 INNER JOIN $tabla2 ON $tabla1.id_h = $tabla2.id_habitacion INNER JOIN $tabla3 ON $tabla1.tipo_h = $tabla3.id_reserva where id_h = :id_h");
